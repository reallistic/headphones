...
class WebInterface(object):
    ...
    def configUpdate(self, http_host='0.0.0.0', http_username=None, http_port=8181, http_password=None, launch_browser=0, api_enabled=0, api_key=None,
        ...
        remix=0, spokenword=0, audiobook=0, autowant_upcoming=False, autowant_all=False, keep_torrent_files=False, prefer_torrents=None, interface=None, log_dir=None, cache_dir=None, music_encoder=0, encoder=None, xldprofile=None,
